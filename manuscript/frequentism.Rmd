...
[Likelihoodism](#likelihoodism) and [Bayesianism](#bayesianism) adhere to the likelihood principle.
...
* Frequentist methods are generally faster to compute than methods from [Bayesian inference](#bayesian) or [machine learning](#supervised-ml).
