...
* The most popular modeling mindset to answer scientific questions.
* Interprets probability as long run frequencies -- from which hypothesis tests, confidence intervals and p-values are derived.
