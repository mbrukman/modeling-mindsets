...
* Model parameters are random variables with a prior distribution.
...
Bayesian inference models the world with parameterized distributions, like all the other statistical modeling mindsets.
...
When there are no specific prior beliefs about the parameter the Bayesian can use an "uninformative" or "objective" priors [@yang1996catalog].
