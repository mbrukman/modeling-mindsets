...
- can be supervised or unsupervised or RL
- results is what counts, BUT with the constraint that its neural networks
- so not a perfectly pure mindset, because it is important what the model is built from
- conditional on NNs, it doesn't matter how the goal is achieved
- like, which archictecture is used
- some people exclusively use deep neural networks
