...
<!-- confusion about statistics versus ml -->
Machine learning is statistics.
Statistics is machiine learning.
Is logistic regression machine learning or statistics?
Machine learning uses many methods from statistic.
It's even called statistical learning sometimes.

<!-- depends on mindset -->   
* ml and stats are different
* it becomes clear when framed as mindset
* mindset of how the world is viewed and what constitutes good models
* and then stats and ml are clearly different
* There is paper bei Breiman
* It's called the two cultures
* In fact, it's the motivation for the entire book
* Paper was eye opening for me as a statistician
* Written by a statistician for statisticians in favor of machine learning
* he called it algorithm modeling and he called statistics dat amodeling
* the subtitle 
...
* X and Y
* TODO: Image of nature (from Breiman). Maybe extend that view to general problems of X?
* Unknown process inbetween
* useful to replicate the process
* how should we go onward with this task?

<!-- statistics -->
* fill the box with probability distributions
* internal view of process
* TODO: Replicate image from Breiman
* principled, internal view of the process 
* Statistical models are based on their components they are build of (internally motivated)
...
<!-- machine learning -->
* Machine learning models are based on how well they do their task, often involving prediction (externally motivated)
* Treat DGP as unknown and unknowable
* Find model that predicts data well (Breiman was more focused on supervised ml)
* Rashomon effext: Multiple models exist that describe the data equally well. The models might disagree on the modeled relationships
* TODO: Replicate image from Breiman about algorithmic modeling culture
...
library(ggplot2)
c1 = circleFun(c(1, 1))
c2 = circleFun(c(0.75, 1), 0.5)
c3 = circleFun(c(0.75, 1), 0.5)
c4 = circleFun(c(0.75, 1), 0.5)
