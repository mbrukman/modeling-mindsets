...
This is called the prior predictive simulation and  serves as a check that the chosen prior probabilities produce data in a reasonable range. The modeler simulates by first samplign parameters from their priors and using those parameters sample data from the data probability function. Repeat many times to get a distribution of data.
