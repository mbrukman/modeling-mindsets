...
Neural network are universal function approximators that can, in theory, approximate any function $f$. <!-- citation needed -->
...
g1 = loess(y ~ x, data = sampl, span = 0.2)
fcurve$g1 = predict(g1, newdata = fcurve)
...
* Generalization error is a good way to quantify generalization, but it can fail in the dumbest ways. There are many examples, like using an asthma diagnosis as a predictor for lower risk of pneumonia<!--citation needed-->, classifying images because of watermarks<!--citation needed-->, wrongly classifying dogs as wolfs because of snow in the background<!--citation needed-->.
