...
```{r underoverfitting, fig.cap = "The true relationship between feature and target (dotted line) is what we look for. But the data generated (points) have some randomness. Two models are shown. One that overfits to the randomness in the training data (black line), and one that underfits (grey line)."}
library(mgcv)
set.seed(5)
