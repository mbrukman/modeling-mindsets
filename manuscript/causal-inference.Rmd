...
"Thank you for this statistical model," the ecologist says to the statistician, and continues, "Nice p-values and insightful results! Can I conclude from the model that the droughts **caused** the crop failures?"
...
"How can we advance science without causality? I want to understand **why** the crop failures happened," the ecologist insists.
