...
Tic-tac-toe and Go are pretty similar games.
...
Tic-tac-toe as environment is often taught in reinforcement learning entry classes.
...
The huge difference between Tic-tac-toe and Go:
The size of action and state spaces.

<!-- Tic-tac-toeis easy -->
In Tic-tac-toe, there are at most 9 possible actions and in the realm of $10^3$ possible action-state pairs.
