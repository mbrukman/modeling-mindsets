...
``When all of you started sprinting, I took a detour. You wouldn't believe it, but I found a rare mushroom that is not supposed to grow in this region. I also clustered the areas around the hut, by the type of vegetation you can find. But the best thing is that, \ldots{}''
...
And yet, they \textbf{know} surprisingly little about the overall patterns in their data: Are there some prototypes of customers?
...
We can measure this similarity based on the features (frequency, location, budget, \ldots) and the distances.
...
\caption{Good clustering solution based on k-means.}\label{fig:clustering1}
\end{figure}
...
\hypertarget{unsupervised-machine-learning-mindset}{%
\section{Unsupervised Machine Learning Mindset}\label{unsupervised-machine-learning-mindset}}
...
Already the word patterns hides a pot luck of types of patterns: clusters, outliers, feature representations, association rules, \ldots{}
...
\caption{Example of 3 clusters in a two-dimensional feature space. The top right data point could be labelled as outlier.}\label{fig:clustering}
\end{figure}
...
They have various motivations, ranging from statistical to more algorithmical, showing again how also unsupervised machine learning is externally motivated: It doesn't particularly matter \emph{how} the clusters are detected.
...
\caption{Worse clustering solution based on ... just picking something by hand.}\label{fig:clustering2}
\end{figure}
...
You can break the curse by finding a priest who is willing to \ldots{}
